...
class BillClass:
    def __init__(self, root):
        ...
        Cal_Cart_Frame.place(x=420,y=190,width=910,height=360)
        ...
        self.cart_Frame.place(x=280,y=10,width=300,height=340)
        ...
        lbl_p_quantity=Label(Add_CartWidgetsFrame,text="Quantity",font=("times new roman",15),bg="white").place(x=390,y=5)
        txt_p_quantity=Entry(Add_CartWidgetsFrame,textvariable=self.var_cartquantity,font=("times new roman",15),bg="lightyellow").place(x=390,y=35,width=120,height=22)
 ...
 #       ========================billing area==================
        ...
        billFrame.place(x=1010,y=110,width=500,height=410)
        ...
        billMenuFrame.place(x=1010,y=520,width=500,height=140)

        self.lbl_amnt=Label(billMenuFrame,text='BillAmount\n[0]',font=("goudy old style",13,"bold"),bg="#3f51b5",fg="white")
        ...
        #==============================Footer===========================
        footer=Label(self.root,text="IMS-Ineventory Management System | \nDeveloped by Parth Bilgaiyan, Parth Dutta & Parth Swamy",font=("times new roman",11),bg="#4d636d",fg="white",bd=0,cursor="hand2").pack(side=BOTTOM,fill=X)
    ...
    def generate_bill(self):
        if self.var_cname.get()==''or self.var_contact.get()=='':
            ...
            try:
                ...
                cur.execute("insert into billingTable (invoiceNumber, customerName,customerPhone) values(?,?,?)",(invoice,name,num))
